...
echo "oneplus-hotdog" | tee rootdir/etc/hostname
echo "127.0.0.1 localhost
127.0.1.1 oneplus-hotdog" | tee rootdir/etc/hosts
...
cp /home/runner/work/ubuntu-oneplus-hotdog/ubuntu-oneplus-hotdog/oneplus-hotdog-debs_$2/*-oneplus-hotdog.deb rootdir/tmp/
chroot rootdir dpkg -i /tmp/linux-oneplus-hotdog.deb
chroot rootdir dpkg -i /tmp/firmware-oneplus-hotdog.deb
#chroot rootdir dpkg -i /tmp/alsa-xiaomi-nabu.deb
rm rootdir/tmp/*-oneplus-hotdog.deb
